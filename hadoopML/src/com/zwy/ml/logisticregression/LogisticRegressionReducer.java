package com.zwy.ml.logisticregression;
...
public class LogisticRegressionReducer extends Reducer<LongWritable, ArrayPrimitiveWritable, Text, ArrayPrimitiveWritable>{
	...
	protected void cleanup(Context context) throws IOException, InterruptedException{
		...
		//context.write(new Text("model: "), new ArrayPrimitiveWritable(theta));
	}
}
